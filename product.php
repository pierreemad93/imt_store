                            ...
                            <div class="summary entry-summary">
                                ...
                                <p class="price">
                                    <?php if (!empty($row['percentage'])) { ?>
                                        <del><span class="amount"><?php echo $row['productprice'] ?> EGP</span>
                                        </del>
                                        <ins>
                                            <span class="amount text-dark font-weight-semibold"><?php echo $row['percentage'] ?>EGP</span>
                                        </ins>
                                    <?php } else { ?>
                                        <ins>
                                            <span class="amount text-dark font-weight-semibold"><?php echo $row["productprice"] ?> EGP</span>
                                        </ins>
                                        <?php
                                    } ?>
                                </p>
                                            ...
                                            <li>
                                                <div class="comment">
                                                    ...
                                                    <div class="comment-block">
                                                        ...
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Nam viverra
                                                            odio, gravida urna varius vitae, gravida pellentesque
                                                            urna varius
                                                            vitae.</p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col">
                                                            ...
                                                            <textarea maxlength="5000"
                                                                      ...
                                                                      rows="8" class="form-control" name="review"
                                                                      id="review"
                                                                      required></textarea>
                                                        </div>
                                                    </div>
